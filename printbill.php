    ...
    <nav class="navbar navbar-custom navbar-fixed-top" role="navigation" style="color: black">
        <div class="container">
            ...
            <li><a href="#" class="dropdown-toggle active" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span class="glyphicon glyphicon-user"></span> Control Panel <span class="caret"></span> </a>
              ...
              <li> <a href="entercar.php">Add Point</a></li>
...
$bike_return_date = date('Y-m-d');
$return_status = "R";
$login_customer = $_SESSION['login_customer'];

$sql0 = "SELECT rc.id, rc.rent_end_date, rc.charge_type, rc.rent_start_date, c.bike_name, c.bike_nameplate FROM rentedbikes rc, bikes c WHERE id = '$id' AND c.bike_id = rc.bike_id";
...
if(mysqli_num_rows($result0) > 0) {
    while($row0 = mysqli_fetch_assoc($result0)){
            ...
            $bike_name = $row0["bike_name"];
            $bike_nameplate = $row0["bike_nameplate"];
...
$extra_days = dateDiff("$rent_end_date", "$bike_return_date");
...
if($charge_type == "days"){
    ...
    $sql1 = "UPDATE rentedbikes SET bike_return_date='$bike_return_date', no_of_days='$no_of_days', total_amount='$total_amount', return_status='$return_status' WHERE id = '$id' ";
} else {
    $distance = $distance_or_days;
    $sql1 = "UPDATE rentedbikes SET bike_return_date='$bike_return_date', distance='$distance', no_of_days='$duration', total_amount='$total_amount', return_status='$return_status' WHERE id = '$id' ";
}

$result1 = $conn->query($sql1);

if ($result1){
     $sql2 = "UPDATE bikes c, driver d, rentedbikes rc SET c.bike_availability='yes', d.driver_availability='yes' 
     WHERE rc.bike_id=c.bike_id AND rc.driver_id=d.driver_id AND rc.customer_username = '$login_customer' AND rc.id = '$id'";
...
?>
    ...
    <div class="container">
        <div class="jumbotron">
            <h1 class="text-center" style="color: green;"><span class="glyphicon glyphicon-ok-circle"></span> Bike Returned Successfully</h1>
        </div>
    </div>
    <br>
    ...
    <div class="container">
        ...
        <div class="box">
            ...
            ?></h4>
                ...
                <br>
                <h4> <strong>Bike Return Date: </strong> <?php echo $bike_return_date; ?> </h4>
                <br>
        ...
        <div class="col-md-12" style="float: none; margin: 0 auto; text-align: center;color:#000;">
