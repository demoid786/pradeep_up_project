...
?>
    ...
    <div class="col-md-7" style="float: none; margin: 0 auto;">
      <div class="form-area">
        <form role="form" action="vehicle_cancelled.php?id=<?php echo $id ?>" method="POST">
        <br style="clear: both">
          <h3 style="margin-bottom: 5px; text-align: center; font-size: 30px;"> CANCEL VEHICLE</h3>
          <h6 style="margin-bottom: 25px; text-align: center; font-size: 12px;"> Allow your driver to fill the below form </h6>
		   ...
		   <a  class="btn btn-success pull-right" href="prereturncar.php">NO</a>
		   <input type="submit" name="submit" value="YES" class="btn btn-success pull-left">
        </form>
      </div>
    </div>
