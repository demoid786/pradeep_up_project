    ...
    <nav class="navbar navbar-custom" role="navigation" style="color: black">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand page-scroll" href="/../bikep/index.php">
                   BIKE POINT </a>
            </div>
        ...
        <div class="cd-faq-items">
            <ul id="basics" class="cd-faq-group">
                ...
                <li>
                    ...
                    <div class="cd-faq-content">
                        <p>Bike Point gladly accepts credit cards/debit cards .Personal Checks are also accepted providing you purchase CDW and Theft Protection on your rental.
                ...
                <li>
                    <a class="cd-faq-trigger" href="#0">What if i find a better rate for a rental bikes?</a>
                    <div class="cd-faq-content">
                        <p>One of the many great things about  bike Rental is our rental rates and services are guaranteed to be the very best in the industry. If you come across a lower price from a competitor and the rate is on a comparable vehicle including the same terms, locations, and rental bike fees we will be glad to beat the price for you. Please complete our Guaranteed Best Rate form if you have found a better rate with one of our competitors.</div>
                    <!-- cd-faq-content -->
                </li>

                <li>
                    <a class="cd-faq-trigger" href="#0">Will i need a driving license to rent a bike?</a>
                    <div class="cd-faq-content">
                ...
                <li>
                    <a class="cd-faq-trigger" href="#0">Is there a fee if i return the bike after the due date?</a>
                    <div class="cd-faq-content">
            ...
            <ul id="chauffeur" class="cd-faq-group">
                ...
                <li>
                    ...
                    <div class="cd-faq-content">
                        <p>Bike Point gladly accepts credit cards/debit cards only further as our software updates we will add more payment options soon .</p> 
                    </div>
                    <!-- cd-faq-content -->
                </li>
                ...
                <li>
                    ...
                    <div class="cd-faq-content">
                        <p>There is no fee to change reservations for chauffeur services.</p>
						
                    </div>
                    <!-- cd-faq-content -->
                </li>
				<li>
                    <a class="cd-faq-trigger" href="#0">If any problem with client Rented Vehicle?</a>
                    <div class="cd-faq-content">
                        <p>please kindly inbox the problem in the Customer My bookings Tab we will solve the issue as soon as possible and will be notified within 1 hr Time</p>
